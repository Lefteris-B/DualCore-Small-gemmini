...
VL_INLINE_OPT void VTestDriver___024root___nba_sequent__TOP__437(VTestDriver___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((~ (IData)(vlSelf->TestDriver__DOT__testHarness__DOT__chiptop0__DOT___system_auto_implicitClockGrouper_out_reset)) 
        ...
        VL_WRITEF("[%0t] %%Error: TLPLIC.sv:172: Assertion failed in %NTestDriver.testHarness.chiptop0.system.plicDomainWrapper.plic: Assertion failed\n    at Plic.scala:245 assert((claimer.asUInt & (claimer.asUInt - 1.U)) === 0.U) // One-Hot\n\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("/home/iamme/chipyard/sims/verilator/generated-src/chipyard.harness.TestHarness.CustomGemminiSoCConfig/gen-collateral/TLPLIC.sv", 172, "");
        if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->TestDriver__DOT__reset))))) {
            VL_WRITEF("[%0t] %%Error: TLPLIC.sv:174: Assertion failed in %NTestDriver.testHarness.chiptop0.system.plicDomainWrapper.plic\n",
                      64,VL_TIME_UNITED_Q(1000),-9,
                      vlSymsp->name());
            VL_STOP_MT("/home/iamme/chipyard/sims/verilator/generated-src/chipyard.harness.TestHarness.CustomGemminiSoCConfig/gen-collateral/TLPLIC.sv", 174, "");
        }
    }
}
...
VL_INLINE_OPT void VTestDriver___024root___nba_sequent__TOP__438(VTestDriver___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((~ (IData)(vlSelf->TestDriver__DOT__testHarness__DOT__chiptop0__DOT___system_auto_implicitClockGrouper_out_reset)) 
        ...
        VL_WRITEF("[%0t] %%Error: TLPLIC.sv:178: Assertion failed in %NTestDriver.testHarness.chiptop0.system.plicDomainWrapper.plic: Assertion failed\n    at Plic.scala:262 assert((completer.asUInt & (completer.asUInt - 1.U)) === 0.U) // One-Hot\n\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("/home/iamme/chipyard/sims/verilator/generated-src/chipyard.harness.TestHarness.CustomGemminiSoCConfig/gen-collateral/TLPLIC.sv", 178, "");
        if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->TestDriver__DOT__reset))))) {
            VL_WRITEF("[%0t] %%Error: TLPLIC.sv:180: Assertion failed in %NTestDriver.testHarness.chiptop0.system.plicDomainWrapper.plic\n",
                      64,VL_TIME_UNITED_Q(1000),-9,
                      vlSymsp->name());
            VL_STOP_MT("/home/iamme/chipyard/sims/verilator/generated-src/chipyard.harness.TestHarness.CustomGemminiSoCConfig/gen-collateral/TLPLIC.sv", 180, "");
        }
    }
}
...
VL_INLINE_OPT void VTestDriver___024root___nba_sequent__TOP__439(VTestDriver___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((~ (IData)(vlSelf->TestDriver__DOT__testHarness__DOT__chiptop0__DOT___system_auto_implicitClockGrouper_out_reset)) 
        ...
        VL_WRITEF("[%0t] %%Error: TLPLIC.sv:184: Assertion failed in %NTestDriver.testHarness.chiptop0.system.plicDomainWrapper.plic: Assertion failed: completerDev should be consistent for all harts\n    at Plic.scala:292 assert(completerDev === data.extract(log2Ceil(nDevices+1)-1, 0),\n\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("/home/iamme/chipyard/sims/verilator/generated-src/chipyard.harness.TestHarness.CustomGemminiSoCConfig/gen-collateral/TLPLIC.sv", 184, "");
        if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->TestDriver__DOT__reset))))) {
            VL_WRITEF("[%0t] %%Error: TLPLIC.sv:186: Assertion failed in %NTestDriver.testHarness.chiptop0.system.plicDomainWrapper.plic\n",
                      64,VL_TIME_UNITED_Q(1000),-9,
                      vlSymsp->name());
            VL_STOP_MT("/home/iamme/chipyard/sims/verilator/generated-src/chipyard.harness.TestHarness.CustomGemminiSoCConfig/gen-collateral/TLPLIC.sv", 186, "");
        }
    }
