...
module LoopConvLdWeight(
  ...
  reg  [14:0] req_addr_end;	// @[LoopConv.scala:434:16]
  reg  [39:0] req_dram_addr;	// @[LoopConv.scala:434:16]
  ...
  wire [63:0] addr_start = {49'h0, req_addr_end} - (req_trans_weight_0132 ? {16'h0, {16'h0, {16'h0, req_derived_params_in_channels_per_bank} * _GEN} * _GEN_0} * _GEN_1 : {16'h0, {16'h0, {16'h0, req_derived_params_out_channels_per_bank} * _GEN} * _GEN_0} * _GEN_2);	// @[LoopConv.scala:434:16, :446:{19,64,72,80}, :447:{27,35,43}, :448:33, :472:114, Mux.scala:101:16]
  ...
  wire        _T_1 = req_dram_addr == 40'h0;	// @[LoopConv.scala:434:16, :520:87, :542:22]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_addr_end = _RANDOM_22[16:2];	// @[LoopConv.scala:434:16]
        req_dram_addr = {_RANDOM_22[31:17], _RANDOM_23[24:0]};	// @[LoopConv.scala:434:16]
        req_trans_weight_1203 = _RANDOM_23[25];	// @[LoopConv.scala:434:16]
        req_trans_weight_0132 = _RANDOM_23[26];	// @[LoopConv.scala:434:16]
        req_dw = _RANDOM_23[27];	// @[LoopConv.scala:434:16]
        req_loop_id = _RANDOM_23[28];	// @[LoopConv.scala:434:16]
        och = {_RANDOM_23[31:29], _RANDOM_24[12:0]};	// @[LoopConv.scala:434:16, :457:16]
        krow = _RANDOM_24[28:13];	// @[LoopConv.scala:457:16, :458:17]
        kcol = {_RANDOM_24[31:29], _RANDOM_25[12:0]};	// @[LoopConv.scala:457:16, :459:17]
        kch = _RANDOM_25[28:13];	// @[LoopConv.scala:459:17, :460:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Pipeline_12 command_p (	// @[LoopConv.scala:490:25]
    ...
    .io_in_bits_cmd_rs1          (_T_3 ? {34'hFE000000, req_derived_params_weight_spad_stride[13:0], 16'h109} : 64'h0),	// @[LoopConv.scala:434:16, :500:25, :505:36, :512:16, :521:{34,41}]
