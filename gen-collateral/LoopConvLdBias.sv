...
module LoopConvLdBias(
  ...
  wire [39:0] _command_p_io_out_bits_dram_addr;	// @[LoopConv.scala:135:25]
  ...
  reg  [9:0]  req_addr_start;	// @[LoopConv.scala:102:16]
  reg  [39:0] req_dram_addr;	// @[LoopConv.scala:102:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_addr_start = _RANDOM_22[11:2];	// @[LoopConv.scala:102:16]
        req_dram_addr = {_RANDOM_22[31:12], _RANDOM_23[19:0]};	// @[LoopConv.scala:102:16]
        req_no_bias = _RANDOM_23[20];	// @[LoopConv.scala:102:16]
        req_loop_id = _RANDOM_23[21];	// @[LoopConv.scala:102:16]
        b = {_RANDOM_23[31:22], _RANDOM_24[5:0]};	// @[LoopConv.scala:102:16, :114:14]
        orow = _RANDOM_24[21:6];	// @[LoopConv.scala:114:14, :115:17]
        ocol = {_RANDOM_24[31:22], _RANDOM_25[5:0]};	// @[LoopConv.scala:114:14, :116:17]
        och = _RANDOM_25[21:6];	// @[LoopConv.scala:116:17, :117:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Pipeline_10 command_p (	// @[LoopConv.scala:135:25]
    ...
    .io_in_bits_cmd_rs1          (_T_2 ? {34'hFE000000, req_derived_params_bias_spad_stride[13:0], 16'h111} : 64'h0),	// @[LoopConv.scala:102:16, :145:25, :150:36, :152:18, :166:{34,41}]
    .io_in_bits_dram_addr        (req_no_bias ? 40'h0 : req_dram_addr + {22'h0, och, 2'h0}),	// @[LoopConv.scala:102:16, :117:16, :121:{22,55}, :139:14]
  ...
  assign io_cmd_bits_rs1 = _T ? {24'h0, _command_p_io_out_bits_dram_addr} : _command_p_io_out_bits_cmd_rs1;	// @[LoopConv.scala:135:25, :174:15, :175:{46,61}, :177:21]
  assign io_cmd_bits_rs2 = _T ? {11'h0, _command_p_io_out_bits_I[4:0], 9'h0, _command_p_io_out_bits_J[6:0], 3'h4, _command_p_io_out_bits_spad_addr[28:26], 11'h0, _command_p_io_out_bits_spad_addr[14:0]} : _command_p_io_out_bits_cmd_rs2;	// @[LocalAddr.scala:108:37, LoopConv.scala:135:25, :174:15, :175:{46,61}, :179:18, :180:27, :181:27, :183:{21,37}]
