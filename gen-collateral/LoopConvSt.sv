...
module LoopConvSt(
  ...
  reg  [9:0]  req_addr_start;	// @[LoopConv.scala:871:16]
  reg  [39:0] req_dram_addr;	// @[LoopConv.scala:871:16]
  ...
  wire [64:0] _GEN_7 = {55'h0, req_addr_start};	// @[LoopConv.scala:871:16, :892:34]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_addr_start = _RANDOM_22[12:3];	// @[LoopConv.scala:871:16]
        req_dram_addr = {_RANDOM_22[31:13], _RANDOM_23[20:0]};	// @[LoopConv.scala:871:16]
        req_no_pool = _RANDOM_23[21];	// @[LoopConv.scala:871:16]
        req_activation = _RANDOM_23[23:22];	// @[LoopConv.scala:871:16]
        req_trans_output_1203 = _RANDOM_23[24];	// @[LoopConv.scala:871:16]
        req_loop_id = _RANDOM_23[25];	// @[LoopConv.scala:871:16]
        b = {_RANDOM_23[31:26], _RANDOM_24[9:0]};	// @[LoopConv.scala:871:16, :882:14]
        orow = _RANDOM_24[25:10];	// @[LoopConv.scala:882:14, :883:17]
        ocol = {_RANDOM_24[31:26], _RANDOM_25[9:0]};	// @[LoopConv.scala:882:14, :884:17]
        och = _RANDOM_25[25:10];	// @[LoopConv.scala:884:17, :885:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Pipeline_14 command_p (	// @[LoopConv.scala:914:25]
    ...
    .io_in_bits_dram_addr        ({28'h0, req_dram_addr} + {1'h0, (req_trans_output_1203 ? {1'h0, {16'h0, {1'h0, {1'h0, {16'h0, _dram_offset_T_10} * {32'h0, req_outer_bounds_batch_size}} + {17'h0, {16'h0, ocol} * {16'h0, req_outer_bounds_batch_size}}} + {34'h0, b}} * {50'h0, req_outer_bounds_out_channels}} + _GEN_1 : {1'h0, {16'h0, {1'h0, {1'h0, {16'h0, _GEN_2 * _GEN_0} * {32'h0, req_outer_bounds_out_dim}} + {17'h0, _dram_offset_T_10}} + {34'h0, ocol}} * {50'h0, req_outer_bounds_out_stride}} + _GEN_1) & 67'hFFFFFFFF}),	// @[LoopConv.scala:869:22, :871:16, :882:14, :884:17, :888:24, :889:{11,19,31,38,50,56,71}, :890:{8,16,25,41,50,63}, :891:33, :1550:17, Mux.scala:101:16]
    .io_in_bits_spad_addr        ({1'h0, {1'h0, {1'h0, _GEN_7 + {1'h0, {16'h0, {16'h0, _GEN_3 * _GEN_4} * _GEN_5} * _GEN_6}} + {18'h0, _GEN_8 * _GEN_9}} + {35'h0, _GEN * {16'h0, req_inner_bounds_ocols}}} + {52'h0, ocol}),	// @[LoopConv.scala:869:22, :871:16, :884:17, :889:11, :892:{34,74,84,92,100,113,121,129,137}, :954:56, Mux.scala:101:16]
    .io_in_bits_pool_dram_addr   ({25'h0, req_dram_addr} + {1'h0, {16'h0, {16'h0, _GEN_2 * {16'h0, req_outer_bounds_pool_out_dim}} * {32'h0, req_outer_bounds_pool_out_dim}} * {48'h0, req_outer_bounds_out_stride} + {48'h0, och}}),	// @[LoopConv.scala:869:22, :871:16, :885:16, :889:19, :890:8, :892:92, :894:{38,44,59,75,88}, :1000:45, Mux.scala:101:16]
