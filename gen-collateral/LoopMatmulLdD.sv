...
module LoopMatmulLdD(
  ...
  reg  [39:0] req_dram_addr;	// @[LoopMatmul.scala:272:16]
  reg  [39:0] req_dram_stride;	// @[LoopMatmul.scala:272:16]
  reg         req_low_d;	// @[LoopMatmul.scala:272:16]
  reg  [9:0]  req_addr_start;	// @[LoopMatmul.scala:272:16]
  ...
  wire [55:0] _dram_offset_T_5 = {40'h0, i} * {16'h0, req_dram_stride};	// @[LoopMatmul.scala:272:16, :278:14, :282:39, Mux.scala:101:16]
  wire [55:0] _GEN = {40'h0, j};	// @[LoopMatmul.scala:277:14, :282:{39,57}]
  wire [28:0] _GEN_0 = {19'h0, req_addr_start} + {{9'h0, i} * {9'h0, req_max_j} + {9'h0, j}, 4'h0};	// @[LoopMatmul.scala:272:16, :277:14, :278:14, :285:{32,37,49}, :287:43, :296:16]
  ...
  wire        _T = req_dram_addr == 40'h0;	// @[LoopMatmul.scala:272:16, :282:39, :311:23]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_dram_addr = {_RANDOM_1[31:9], _RANDOM_2[16:0]};	// @[LoopMatmul.scala:272:16]
        req_dram_stride = {_RANDOM_2[31:17], _RANDOM_3[24:0]};	// @[LoopMatmul.scala:272:16]
        req_low_d = _RANDOM_3[25];	// @[LoopMatmul.scala:272:16]
        req_addr_start = {_RANDOM_3[31:26], _RANDOM_4[3:0]};	// @[LoopMatmul.scala:272:16]
        req_loop_id = _RANDOM_4[4];	// @[LoopMatmul.scala:272:16]
        j = _RANDOM_4[20:5];	// @[LoopMatmul.scala:272:16, :277:14]
        i = {_RANDOM_4[31:21], _RANDOM_5[4:0]};	// @[LoopMatmul.scala:272:16, :278:14]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_cmd_bits_rs1 = {24'h0, req_dram_addr} + ((req_low_d ? {4'h0, _dram_offset_T_5 + _GEN, 4'h0} : {2'h0, _dram_offset_T_5 + _GEN, 6'h0}) & 64'hFFFFFFFF);	// @[LoopMatmul.scala:272:16, :282:{24,39,57}, :283:{26,46}, :284:33, :287:43, :291:12, :1139:17]
  assign io_cmd_bits_rs2 = {11'h0, 5'h10 - {1'h0, i == _rows_T_1 ? req_pad_i : 4'h0}, 9'h0, {blocks[2:0], 4'h0} - {3'h0, j + blocks >= req_max_j ? req_pad_j : 4'h0}, 3'h4, _GEN_0[28:26], 11'h0, _GEN_0[14:0]};	// @[LocalAddr.scala:108:37, LoopMatmul.scala:270:22, :272:16, :277:14, :278:14, :285:32, :286:19, :287:{38,43,46,55}, :288:{27,32,35,48}, :296:16, :300:32]
