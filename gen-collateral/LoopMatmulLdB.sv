...
module LoopMatmulLdB(
  ...
  wire [13:0] mvin_cmd_rs2_local_addr_data;	// @[LoopMatmul.scala:196:27, :199:23, :200:29]
  ...
  reg  [39:0] req_dram_addr;	// @[LoopMatmul.scala:161:16]
  reg  [39:0] req_dram_stride;	// @[LoopMatmul.scala:161:16]
  reg         req_transpose;	// @[LoopMatmul.scala:161:16]
  reg  [14:0] req_addr_end;	// @[LoopMatmul.scala:161:16]
  ...
  wire [28:0] _GEN = {14'h0, req_addr_end};	// @[LoopMatmul.scala:161:16, :178:{26,69}]
  ...
  assign mvin_cmd_rs2_local_addr_garbage_bit = req_is_resadd ? _GEN_0[14] : _GEN_0[14];	// @[LocalAddr.scala:108:37, LoopMatmul.scala:161:16, :182:31, :196:27, :199:23, :200:29]
  assign mvin_cmd_rs2_local_addr_data = req_is_resadd ? _GEN_0[13:0] : _GEN_0[13:0];	// @[LocalAddr.scala:108:37, LoopMatmul.scala:161:16, :182:31, :196:27, :199:23, :200:29]
  wire        _io_cmd_valid_output = state & ~io_rob_overloaded & (|req_dram_addr);	// @[LoopMatmul.scala:159:22, :161:16, :208:{37,56,73}]
  wire        _T = req_dram_addr == 40'h0;	// @[LoopMatmul.scala:161:16, :180:35, :213:22]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_dram_addr = {_RANDOM_1[31:9], _RANDOM_2[16:0]};	// @[LoopMatmul.scala:161:16]
        req_dram_stride = {_RANDOM_2[31:17], _RANDOM_3[24:0]};	// @[LoopMatmul.scala:161:16]
        req_transpose = _RANDOM_3[25];	// @[LoopMatmul.scala:161:16]
        req_addr_end = {_RANDOM_3[31:26], _RANDOM_4[8:0]};	// @[LoopMatmul.scala:161:16]
        req_loop_id = _RANDOM_4[9];	// @[LoopMatmul.scala:161:16]
        req_is_resadd = _RANDOM_4[10];	// @[LoopMatmul.scala:161:16]
        k = _RANDOM_4[26:11];	// @[LoopMatmul.scala:161:16, :163:14]
        j = {_RANDOM_4[31:27], _RANDOM_5[10:0]};	// @[LoopMatmul.scala:161:16, :164:14]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_cmd_bits_rs1 = {2'h0, {22'h0, req_dram_addr} + {2'h0, {40'h0, row_iterator} * {16'h0, req_dram_stride} + {40'h0, col_iterator} & 56'hFFFFFFF, 4'h0}};	// @[LoopMatmul.scala:161:16, :166:25, :167:25, :178:26, :180:{35,53}, :181:33, :184:43, :185:27, :190:16, :1139:17, Mux.scala:101:16]
  assign io_cmd_bits_rs2 = {11'h0, 5'h10 - {1'h0, max_row_iterator == max_row_iterator - 16'h1 ? (req_transpose ? req_pad_j : req_pad_k) : 4'h0}, 9'h0, {blocks[2:0], 4'h0} - {3'h0, col_iterator + blocks >= max_col_iterator ? (req_transpose ? req_pad_k : req_pad_j) : 4'h0}, {2{req_is_resadd}}, 1'h0, mvin_cmd_rs2_local_addr_norm_cmd, 11'h0, mvin_cmd_rs2_local_addr_garbage_bit, mvin_cmd_rs2_local_addr_data};	// @[LoopMatmul.scala:159:22, :161:16, :167:25, :169:29, :170:29, :172:20, :173:20, :183:19, :184:{38,43,57,66}, :185:{27,32,50,70}, :193:16, :196:27, :197:32, :199:23, :200:29]
