...
module StreamReaderCore(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_beatData_bits_last_counter = _RANDOM_8[16:9];	// @[DMA.scala:159:18, Edges.scala:229:27]
  ...
  assign io_reserve_entry_addr = req_spaddr + req_block_stride[13:0] * {8'h0, req_has_acc_bitwidth ? 6'h0 : bytesRequested / 6'h10};	// @[Cat.scala:33:92, DMA.scala:159:18, :162:29, :266:{41,60}, :267:10, :272:81, Edges.scala:229:27]
