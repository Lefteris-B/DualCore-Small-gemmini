...
module LoopMatmulStC(
  ...
  wire [55:0]     _ln_dram_offset_T = {40'h0, i} * {16'h0, req_dram_stride};	// @[LoopMatmul.scala:540:16, :546:14, :550:40, Mux.scala:101:16]
  wire [55:0]     _GEN_3 = {40'h0, j};	// @[LoopMatmul.scala:545:14, :550:{40,58}]
  wire [63:0]     _GEN_4 = {24'h0, req_dram_addr};	// @[LoopMatmul.scala:540:16, :552:33]
  wire [24:0]     _GEN_5 = {9'h0, i} * {9'h0, req_max_j};	// @[LoopMatmul.scala:540:16, :546:14, :553:37, :564:17]
  wire [28:0]     _GEN_6 = {19'h0, req_addr_start} + {_GEN_5 + {9'h0, j}, 4'h0};	// @[LoopMatmul.scala:540:16, :545:14, :553:{32,37,49}, :555:43, :564:17]
  ...
  wire            _T = req_dram_addr == 40'h0;	// @[LoopMatmul.scala:540:16, :550:40, :644:23]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_dram_addr = {_RANDOM_1[31:26], _RANDOM_2, _RANDOM_3[1:0]};	// @[LoopMatmul.scala:540:16]
        req_dram_stride = {_RANDOM_3[31:2], _RANDOM_4[9:0]};	// @[LoopMatmul.scala:540:16]
        req_full_c = _RANDOM_4[10];	// @[LoopMatmul.scala:540:16]
        req_act = _RANDOM_4[13:11];	// @[LoopMatmul.scala:540:16]
        req_addr_start = _RANDOM_4[23:14];	// @[LoopMatmul.scala:540:16]
        req_loop_id = _RANDOM_4[24];	// @[LoopMatmul.scala:540:16]
        req_is_resadd = _RANDOM_4[25];	// @[LoopMatmul.scala:540:16]
        j = {_RANDOM_4[31:26], _RANDOM_5[9:0]};	// @[LoopMatmul.scala:540:16, :545:14]
        i = _RANDOM_5[25:10];	// @[LoopMatmul.scala:545:14, :546:14]
        ln_row = {_RANDOM_5[31:26], _RANDOM_6[9:0]};	// @[LoopMatmul.scala:545:14, :571:19]
        ln_cmd = _RANDOM_6[25:10];	// @[LoopMatmul.scala:571:19, :572:19]
        ln_stat_id = {_RANDOM_6[31:26], _RANDOM_7[9:0]};	// @[LoopMatmul.scala:571:19, :573:23]
      `endif // RANDOMIZE_REG_INIT
    end // initial
