...
module LoopMatmulExecute(
  ...
  wire [28:0] _GEN_0 = {15'h0, req_a_addr_start} + {{9'h0, req_a_tranpose ? k : i} * {9'h0, req_a_tranpose ? req_max_i : req_max_k} + {9'h0, req_a_tranpose ? i : k}, 4'h0};	// @[LoopMatmul.scala:384:16, :389:14, :391:14, :393:18, :394:18, :398:22, :401:{33,42,54}, :405:34]
  wire [28:0] _GEN_1 = {14'h0, req_b_addr_end} - {{9'h0, req_max_k} * _GEN, 4'h0} + {{9'h0, req_b_tranpose ? j : k} * {9'h0, req_b_tranpose ? req_max_k : req_max_j} + {9'h0, req_b_tranpose ? k : j}, 4'h0};	// @[LoopMatmul.scala:384:16, :387:{37,49}, :389:14, :390:14, :395:18, :396:18, :399:22, :401:54, :402:{29,38,50}, :405:34]
  wire [28:0] _GEN_2 = {19'h0, req_c_addr_start} + {{9'h0, i} * _GEN + {9'h0, j}, 4'h0};	// @[LoopMatmul.scala:384:16, :387:49, :390:14, :391:14, :401:54, :403:{29,34,46}, :405:34]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_a_addr_start = _RANDOM_2[14:1];	// @[LoopMatmul.scala:384:16]
        req_b_addr_end = _RANDOM_2[29:15];	// @[LoopMatmul.scala:384:16]
        req_c_addr_start = {_RANDOM_2[31:30], _RANDOM_3[7:0]};	// @[LoopMatmul.scala:384:16]
        req_loop_id = _RANDOM_3[8];	// @[LoopMatmul.scala:384:16]
        req_skip = _RANDOM_3[9];	// @[LoopMatmul.scala:384:16]
        k = _RANDOM_3[25:10];	// @[LoopMatmul.scala:384:16, :389:14]
        j = {_RANDOM_3[31:26], _RANDOM_4[9:0]};	// @[LoopMatmul.scala:384:16, :390:14]
        i = _RANDOM_4[25:10];	// @[LoopMatmul.scala:390:14, :391:14]
      `endif // RANDOMIZE_REG_INIT
    end // initial
