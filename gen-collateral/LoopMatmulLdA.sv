...
module LoopMatmulLdA(
  ...
  wire [13:0] mvin_cmd_rs2_local_addr_data;	// @[LoopMatmul.scala:82:27, :84:22, :85:29]
  ...
  reg  [39:0] req_dram_addr;	// @[LoopMatmul.scala:47:16]
  reg  [39:0] req_dram_stride;	// @[LoopMatmul.scala:47:16]
  reg         req_transpose;	// @[LoopMatmul.scala:47:16]
  reg  [13:0] req_addr_start;	// @[LoopMatmul.scala:47:16]
  ...
  wire [28:0] _GEN = {15'h0, req_addr_start} + {{9'h0, row_iterator} * {9'h0, max_col_iterator} + {9'h0, col_iterator}, 4'h0};	// @[LoopMatmul.scala:47:16, :52:25, :53:25, :56:29, :68:{31,47,66}, :70:43, :79:16]
  ...
  assign mvin_cmd_rs2_local_addr_garbage_bit = req_is_resadd ? _GEN[14] : _GEN[14];	// @[LocalAddr.scala:108:37, LoopMatmul.scala:47:16, :68:31, :82:27, :84:22, :85:29]
  assign mvin_cmd_rs2_local_addr_data = req_is_resadd ? _GEN[13:0] : _GEN[13:0];	// @[LocalAddr.scala:108:37, LoopMatmul.scala:47:16, :68:31, :82:27, :84:22, :85:29]
  wire        _io_cmd_valid_output = state & ~io_rob_overloaded & (|req_dram_addr);	// @[LoopMatmul.scala:45:22, :47:16, :93:{37,56,73}]
  wire        _T = req_dram_addr == 40'h0;	// @[LoopMatmul.scala:47:16, :66:35, :98:22]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_dram_addr = {_RANDOM_1[31:9], _RANDOM_2[16:0]};	// @[LoopMatmul.scala:47:16]
        req_dram_stride = {_RANDOM_2[31:17], _RANDOM_3[24:0]};	// @[LoopMatmul.scala:47:16]
        req_transpose = _RANDOM_3[25];	// @[LoopMatmul.scala:47:16]
        req_addr_start = {_RANDOM_3[31:26], _RANDOM_4[7:0]};	// @[LoopMatmul.scala:47:16]
        req_loop_id = _RANDOM_4[8];	// @[LoopMatmul.scala:47:16]
        req_is_resadd = _RANDOM_4[9];	// @[LoopMatmul.scala:47:16]
        i = _RANDOM_4[25:10];	// @[LoopMatmul.scala:47:16, :49:14]
        k = {_RANDOM_4[31:26], _RANDOM_5[9:0]};	// @[LoopMatmul.scala:47:16, :50:14]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_cmd_bits_rs1 = {2'h0, {22'h0, req_dram_addr} + {2'h0, {40'h0, row_iterator} * {16'h0, req_dram_stride} + {40'h0, col_iterator} & 56'hFFFFFFF, 4'h0}};	// @[LoopMatmul.scala:47:16, :52:25, :53:25, :66:{35,53}, :67:33, :70:43, :74:12, :76:16, :1139:17, Mux.scala:101:16]
  assign io_cmd_bits_rs2 = {11'h0, 5'h10 - {1'h0, row_iterator == (req_transpose ? req_max_k : req_max_i) - 16'h1 ? (req_transpose ? req_pad_k : req_pad_i) : 4'h0}, 9'h0, {blocks[2:0], 4'h0} - {3'h0, col_iterator + blocks >= max_col_iterator ? (req_transpose ? req_pad_i : req_pad_k) : 4'h0}, req_is_resadd, 2'h0, mvin_cmd_rs2_local_addr_norm_cmd, 11'h0, mvin_cmd_rs2_local_addr_garbage_bit, mvin_cmd_rs2_local_addr_data};	// @[LoopMatmul.scala:45:22, :47:16, :52:25, :53:25, :55:29, :56:29, :58:20, :59:20, :69:19, :70:{38,43,57,66}, :71:{27,32,46,66}, :74:12, :79:16, :82:27, :83:32, :84:22, :85:29]
